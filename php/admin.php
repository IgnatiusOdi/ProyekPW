<?php
    ...
    foreach ($listBarang as $key => $value) {
        if (isset($_REQUEST["edit-" . $value['id_barang']])) {
...
<body>
    ...
    <form action="" method="post" class="content">
        ...
        <button name="search" class="btn btn-outline-success">Search</button>
        <button name="clear" class="btn btn-outline-secondary">Clear</button><br>
        <?php
            if ($pageAktif > 1) {
                ...
                <table border=1 class="table">
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><?=$value['stok_barang']?></td>
                                <?php
                                ...
                                <td style="text-align: center;"><button class="btn btn-light" name="edit-<?=$value['id_barang']?>">Edit</button></td>
                            </tr>
                    <?php
                        endforeach;
                    ?>
